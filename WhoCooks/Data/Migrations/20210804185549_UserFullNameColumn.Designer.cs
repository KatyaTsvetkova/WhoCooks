...
namespace WhoCooks.Data.Migrations
{
    ...
    [Migration("20210804185549_UserFullNameColumn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhoCooks.Data.HowToArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WhoCooks.Data.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WhoCooks.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WhoCooks.Data.Chef", b =>
                {
                    b.HasOne("WhoCooks.Data.User", null)
                        .WithOne()
                        .HasForeignKey("WhoCooks.Data.Chef", "UserId")
            ...
            modelBuilder.Entity("WhoCooks.Data.Recipe", b =>
                {
                    b.HasOne("WhoCooks.Data.Category", "Category")
